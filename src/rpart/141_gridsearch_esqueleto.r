...
PARAM$semillas <- c(306577, 423179, 680081, 872621, 310243, 295073)
...
for (vmax_depth in c(4, 6, 8, 10, 12)) {
  for (vmin_split in c(1400,1000, 800, 600, 400, 200,150)) {
#    for (minbucket in c(100, 200, 300, 400, 500, 10, 20, 30, 40, 50, 60, 70, 80, 90, 5, 10, 15, 20, 25)) {
     for (vminbucket in floor((vmin_split/2) %*% c(1, .5, .3, .2, .1, .05))){
      for (vcp in seq(-0.03, 0.01, by = 0.01)) {
        
        # notar como se agrega
        if (vmin_split >= 2 * vminbucket) {
