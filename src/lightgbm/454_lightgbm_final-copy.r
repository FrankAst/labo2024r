...
PARAM$finalmodel$num_iterations <- 1422
PARAM$finalmodel$learning_rate <- 0.0102807806401806
PARAM$finalmodel$feature_fraction <- 0.266632670519183
PARAM$finalmodel$min_data_in_leaf <- 1375
PARAM$finalmodel$num_leaves <- 80
